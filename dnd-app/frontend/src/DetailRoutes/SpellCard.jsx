						...
						<CardBody>
							...
							<CardSubtitle>
								...
								{data.requires_verbal_components ? (
									<>
										<Badge pill className="m-1 btn" id="verbal">
											V
										</Badge>
										<UncontrolledPopover target="verbal" placement="bottom" trigger="legacy">
											<PopoverHeader>Verbal</PopoverHeader>
											<PopoverBody>
								...
								{data.requires_somatic_components ? (
									<>
										<Badge id="somatic" pill className="m-1 btn">
											S
										</Badge>
										<UncontrolledPopover target="somatic" placement="bottom" trigger="legacy">
											<PopoverHeader>Somatic</PopoverHeader>
											<PopoverBody>
								...
								{data.requires_material_components ? (
									<>
										<Badge id="material" pill className="m-1 btn">
											M
										</Badge>
										<UncontrolledPopover target="material" placement="bottom" trigger="legacy">
											<PopoverHeader>Material</PopoverHeader>
											<PopoverBody>
								...
								{data.can_be_cast_as_ritual ? (
									<>
										<Badge pill className="m-1" color="success" id="ritual">
											R
										</Badge>
										<UncontrolledPopover target="ritual" placement="bottom" trigger="legacy">
											<PopoverHeader>Ritual</PopoverHeader>
											<PopoverBody>
								...
								{data.requires_concentration ? (
									<>
										<Badge pill className="m-1" color="primary" id="concentration">
											C
										</Badge>
										<UncontrolledPopover target="concentration" placement="bottom" trigger="legacy">
											<PopoverHeader>Concentration</PopoverHeader>
											<PopoverBody>
												...
												<ListGroup>
													<ListGroupItem>
														<strong>Casting another spell that requires concentration.</strong> You lose concentration on
														a spell if you cast another spell that requires concentration. You can’t concentrate on two
														spells at once.
													</ListGroupItem>
													<ListGroupItem>
														<strong>Taking damage.</strong> Whenever you take damage while you are concentrating on a
													...
													<ListGroupItem>
														<strong>Being incapacitated or killed.</strong> You lose concentration on a spell if you are
							...
							<Row>
								...
								<Col>
									<strong>Casting Time:</strong> {data.casting_time}
								</Col>
							</Row>
							{data.higher_level !== "" ? (
								<>
									<hr />
									<CardText>
										<strong>Higher Level:</strong> {data.higher_level}
									</CardText>
								</>
							) : (
								<></>
